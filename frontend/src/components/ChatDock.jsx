  ...
  return (
    <>
      ...
      <div
        role="button"
        onClick={openSheet}
        className="flex-shrink-0 bg-white border-t border-[rgba(47,47,47,0.08)] px-5 py-4 flex items-center justify-between cursor-pointer active:bg-[rgba(47,47,47,0.03)]"
      >
      ...
      {isOpen && (
        <div
          className="fixed bottom-0 left-1/2 -translate-x-1/2 w-full max-w-[420px] h-dvh z-50 bg-white flex flex-col"
          style={sheetStyle}
        >
          ...
          {/* Topic title + meta */}
          <div className="flex-shrink-0 px-5 pt-2 pb-2 border-b border-[rgba(47,47,47,0.08)] text-center">
            <h2 className="font-title text-[21px] font-semibold text-[#2F2F2F] leading-snug">
              {topic.title}
            </h2>
          ...
          <div className="flex-1 overflow-y-auto px-4 py-4 space-y-3">
            {messages.length === 0 && !sending && (
              <div className="flex items-center justify-center h-full">
                <p className="text-[#C4BFB6] text-sm text-center px-8">
              ...
              <div key={i} className={`flex ${msg.role === 'user' ? 'justify-end' : 'justify-start'}`}>
                <div className={`max-w-[82%] px-3 py-2.5 rounded-2xl text-sm leading-relaxed ${
                  msg.role === 'user'
                    ...
                    : 'bg-[#F4F1EA] text-[#2F2F2F] rounded-bl-sm'
                }`}>
            ...
            {sending && (
              <div className="flex justify-start">
                <div className="bg-[#F4F1EA] px-3 py-2.5 rounded-2xl rounded-bl-sm text-sm text-[#969B92]">
                  Escribiendo...
                </div>
              </div>
            )}
          ...
          {/* Input */}
          <div className="flex-shrink-0 border-t border-[rgba(47,47,47,0.08)] px-4 pt-3 pb-3">
            ...
            <div className="flex gap-2">
              <input
                ...
                className="flex-1 h-11 px-3 bg-[#F4F1EA] border border-[rgba(47,47,47,0.12)] rounded-xl text-sm placeholder-[#C4BFB6] disabled:opacity-50 focus:outline-none focus:border-[#BFA56A] transition-colors"
              />
              <button
                onClick={handleSend}
