  ...
  return (
    <div className="min-h-screen bg-[#F4F1EA] dark:bg-[#1A1814] flex flex-col items-center justify-center px-5">
      <div className="w-full max-w-[420px] mx-auto">
        ...
        {/* Card */}
        <div className="bg-white dark:bg-[#252220] rounded-[16px] px-6 py-8 shadow-[0_2px_20px_rgba(47,47,47,0.07)]">
          <h2 className="font-title text-[28px] font-semibold text-[#2F2F2F] dark:text-[#EDE9E1] text-center leading-snug tracking-[-0.01em] mb-1">Crear cuenta</h2>
          <div className="w-8 h-[2px] bg-[#BFA56A] mx-auto mb-6 rounded-full opacity-70" />

          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              <label className="block text-sm font-medium text-[#6B7280] dark:text-[#9CA3AF] mb-1.5 uppercase tracking-[0.04em]">Email</label>
              <input
                type="email"
                value={email}
            ...
            <div>
              <label className="block text-sm font-medium text-[#6B7280] dark:text-[#9CA3AF] mb-1.5 uppercase tracking-[0.04em]">Contraseña</label>
              <input
                type="password"
                value={password}
            ...
            <div>
              <label className="block text-sm font-medium text-[#6B7280] dark:text-[#9CA3AF] mb-1.5 uppercase tracking-[0.04em]">Confirmar contraseña</label>
              <input
                type="password"
                value={confirm}
